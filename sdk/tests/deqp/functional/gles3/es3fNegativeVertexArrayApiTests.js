    ...
    */
    es3fNegativeVertexArrayApiTests.init = function(gl) {
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('draw_elements', 'Invalid gl.drawElements() usage', gl, function()
        {
            ...
            bufferedLogToConsole('gl.INVALID_ENUM is generated if mode is not an accepted value.');
            gl.drawElements(-1, 1, gl.UNSIGNED_BYTE, vertices[0]);
            this.expectError(gl.INVALID_ENUM);


            bufferedLogToConsole('gl.INVALID_ENUM is generated if type is not one of the accepted values.');
            gl.drawElements(gl.POINTS, 1, -1, vertices[0]);
            this.expectError(gl.INVALID_ENUM);
            gl.drawElements(gl.POINTS, 1, gl.FLOAT, vertices[0]);
            this.expectError(gl.INVALID_ENUM);


            bufferedLogToConsole('gl.INVALID_VALUE is generated if count is negative.');
            gl.drawElements(gl.POINTS, -1, gl.UNSIGNED_BYTE, vertices[0]);
            this.expectError(gl.INVALID_VALUE);
            ...
            if (!sglrGLContext.isExtensionSupported(gl,  'gl.EXT_geometry_shader')) // gl.EXT_geometry_shader removes error
            {
                ...
                /** @type{Array<string>} */ var tfVarying		= ['gl.Position'];
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('draw_elements_incomplete_primitive', 'Invalid gl.drawElements() usage', gl, function()
        {
            ...
            bufferedLogToConsole('gl.INVALID_ENUM is generated if type is not one of the accepted values.');
            gl.drawElements(gl.TRIANGLES, 1, -1, vertices[0]);
            this.expectError(gl.INVALID_ENUM);
            gl.drawElements(gl.TRIANGLES, 1, gl.FLOAT, vertices[0]);
            this.expectError(gl.INVALID_ENUM);


            bufferedLogToConsole('gl.INVALID_VALUE is generated if count is negative.');
            gl.drawElements(gl.TRIANGLES, -1, gl.UNSIGNED_BYTE, vertices[0]);
            this.expectError(gl.INVALID_VALUE);
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('draw_elements_instanced', 'Invalid gl.drawElementsInstanced() usage', gl, function()
        {
            ...
            bufferedLogToConsole('gl.INVALID_ENUM is generated if mode is not an accepted value.');
            gl.drawElementsInstanced(-1, 1, gl.UNSIGNED_BYTE, vertices[0], 1);
            this.expectError(gl.INVALID_ENUM);


            bufferedLogToConsole('gl.INVALID_ENUM is generated if type is not one of the accepted values.');
            gl.drawElementsInstanced(gl.POINTS, 1, -1, vertices[0], 1);
            this.expectError(gl.INVALID_ENUM);
            gl.drawElementsInstanced(gl.POINTS, 1, gl.FLOAT, vertices[0], 1);
            this.expectError(gl.INVALID_ENUM);


            bufferedLogToConsole('gl.INVALID_VALUE is generated if count or primcount are negative.');
            gl.drawElementsInstanced(gl.POINTS, -1, gl.UNSIGNED_BYTE, vertices[0], 1);
            this.expectError(gl.INVALID_VALUE);
            gl.drawElementsInstanced(gl.POINTS, 11, gl.UNSIGNED_BYTE, vertices[0], -1);
            this.expectError(gl.INVALID_VALUE);
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('draw_elements_instanced_incomplete_primitive', 'Invalid gl.drawElementsInstanced() usage', gl, function()
        {
            ...
            bufferedLogToConsole('gl.INVALID_ENUM is generated if type is not one of the accepted values.');
            gl.drawElementsInstanced(gl.TRIANGLES, 1, -1, vertices[0], 1);
            this.expectError(gl.INVALID_ENUM);
            gl.drawElementsInstanced(gl.TRIANGLES, 1, gl.FLOAT, vertices[0], 1);
            this.expectError(gl.INVALID_ENUM);


            bufferedLogToConsole('gl.INVALID_VALUE is generated if count or primcount are negative.');
            gl.drawElementsInstanced(gl.TRIANGLES, -1, gl.UNSIGNED_BYTE, vertices[0], 1);
            this.expectError(gl.INVALID_VALUE);
            gl.drawElementsInstanced(gl.TRIANGLES, 11, gl.UNSIGNED_BYTE, vertices[0], -1);
            this.expectError(gl.INVALID_VALUE);
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('draw_range_elements', 'Invalid gl.drawRangeElements() usage', gl, function()
        {
            ...
            bufferedLogToConsole('gl.INVALID_ENUM is generated if mode is not an accepted value.');
            gl.drawRangeElements(-1, 0, 1, 1, gl.UNSIGNED_BYTE, vertices[0]);
            this.expectError(gl.INVALID_ENUM);


            bufferedLogToConsole('gl.INVALID_ENUM is generated if type is not one of the accepted values.');
            gl.drawRangeElements(gl.POINTS, 0, 1, 1, -1, vertices[0]);
            this.expectError(gl.INVALID_ENUM);
            gl.drawRangeElements(gl.POINTS, 0, 1, 1, gl.FLOAT, vertices[0]);
            this.expectError(gl.INVALID_ENUM);


            bufferedLogToConsole('gl.INVALID_VALUE is generated if count is negative.');
            gl.drawRangeElements(gl.POINTS, 0, 1, -1, gl.UNSIGNED_BYTE, vertices[0]);
            this.expectError(gl.INVALID_VALUE);


            bufferedLogToConsole('gl.INVALID_VALUE is generated if end < start.');
            gl.drawRangeElements(gl.POINTS, 1, 0, 1, gl.UNSIGNED_BYTE, vertices[0]);
            this.expectError(gl.INVALID_VALUE);
        ...
        testGroup.addChild(new es3fApiCase.ApiCaseCallback('draw_range_elements_incomplete_primitive', 'Invalid gl.drawRangeElements() usage', gl, function()
        {
            ...
            bufferedLogToConsole('gl.INVALID_ENUM is generated if type is not one of the accepted values.');
            gl.drawRangeElements(gl.TRIANGLES, 0, 1, 1, -1, vertices[0]);
            this.expectError(gl.INVALID_ENUM);
            gl.drawRangeElements(gl.TRIANGLES, 0, 1, 1, gl.FLOAT, vertices[0]);
            this.expectError(gl.INVALID_ENUM);


            bufferedLogToConsole('gl.INVALID_VALUE is generated if count is negative.');
            gl.drawRangeElements(gl.TRIANGLES, 0, 1, -1, gl.UNSIGNED_BYTE, vertices[0]);
            this.expectError(gl.INVALID_VALUE);


            bufferedLogToConsole('gl.INVALID_VALUE is generated if end < start.');
            gl.drawRangeElements(gl.TRIANGLES, 1, 0, 1, gl.UNSIGNED_BYTE, vertices[0]);
            this.expectError(gl.INVALID_VALUE);
